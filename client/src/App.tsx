...
function App() {
	...
	return (
		<BrowserRouter basename="/">
			<Routes>
				<Route element={<BaseLayout DEVICE_TYPE={DEVICE_TYPE} isLoggedIn={isLoggedIn} isAdmin={hasAdminRights} logOut={logOut} notification_visible={notification_visible} notification_message={notification_message} notification_type={notification_type} setNotificationMessage={setNotificationMessageWrapper} setNotificationType={setNotificationTypeWrapper} />} >
