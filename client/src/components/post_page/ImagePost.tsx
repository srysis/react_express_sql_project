			...
			<div className="wrapper">
				<div className="post_content">
					...
					<div className="content">
						<img src={`${import.meta.env.VITE_POST_IMAGE_STORAGE}${post_content}`} />
					</div>
				</div>
				{post_ownership && 
